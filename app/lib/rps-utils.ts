...
export const RPS_CONFIG = {
  ...
  OPEN_GAME_TIMEOUT_MS: 24 * 60 * 60 * 1000,  // 24 hours for open challenges
  GAME_EXPIRE_HOURS: 24,
  ROUND_TIMEOUT_HOURS: 1,
  // On-chain config (Base)
  ESCROW_ADDRESS: '0xEa12B70545232286Ac42fB5297a9166A1A77735B', // Original escrow (works with standard createGame)
  ESCROW_V1_ADDRESS: '0xEa12B70545232286Ac42fB5297a9166A1A77735B', // V1 legacy
